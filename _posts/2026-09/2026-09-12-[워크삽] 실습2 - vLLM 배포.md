...
최적화된 Pod 패턴으로 vLLM을 성공적으로 배포한 후 [Ingress 및 Load Balancing](https://catalog.us-east-1.prod.workshops.aws/workshops/177cf2c8-d451-405b-a463-eb77d38b8617/en-US/vllm/ingress-k8s/) 섹션으로 이동한다. 이 섹션에서는 vLLM 배포를 위한 외부 접근과 Load Balancing을 설정한다.
