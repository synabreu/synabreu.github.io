...
![Figure 1. VS Code에서 workshop 폴더 열기](figure-1-vscode-open-workshop.jpg)

*Figure 1. VS Code에서 `workshop` 폴더 열기*

![Figure 2. VS Code에서 workshop Terminal 열기](figure-2-vscode-workshop-terminal.jpg)

*Figure 2. VS Code에서 `workshop` Terminal 열기*
...
![Figure 5. S3 CSI Driver Pod 실행 상태](figure-5-s3-csi-driver-pods.png)

*Figure 5. S3 CSI Driver Pod 실행 상태*
