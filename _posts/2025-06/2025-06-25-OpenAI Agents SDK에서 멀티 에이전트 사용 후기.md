...
* 데모 동영상 설명
  ...
  *  "NVIDIA GB-200이 무엇인지, 사양과 특징에 대해" 한글 리포트를 작성하라고 프롬프트 명령을 내렸더니, 자동적으로 에이전트 시스템이 검색과 리포트를 작동시킴
  * 무료 검색 도구인 DuckDuckGo 검색 엔진을 사용했더니, 랙이 좀 발생하는 것 빼고는 한글도 잘 작성되고 PDF로도 저장해서 잘 만들어지는 결과를 볼 수 있음
